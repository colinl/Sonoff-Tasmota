...
#undef CFG_HOLDER
#endif
#define CFG_HOLDER           0x18111401   // yymmddnn  change this to force changes to be used immediately
...
#endif
#define WIFI_IP_ADDRESS      "192.168.50.87"
...
#endif
#define MQTT_FULLTOPIC         "tydwr/dsbed/%topic%/%prefix%/" // [FullTopic] Subscribe and Publish full topic name

#ifdef MQTT_TOPIC
#undef MQTT_TOPIC
#endif
#define MQTT_TOPIC             "s006"           // [Topic] (unique) MQTT device topic
...
#undef FRIENDLY_NAME
#endif
#define FRIENDLY_NAME        "s006"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
