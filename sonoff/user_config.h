...
// -- Wifi ----------------------------------------
#define WIFI_IP_ADDRESS        "192.168.51.98"   // [IpAddress1] Set to 0.0.0.0 for using DHCP or IP address
#define WIFI_GATEWAY           "192.168.51.1"    // [IpAddress2] If not using DHCP set Gateway IP address
#define WIFI_SUBNETMASK        "255.255.255.0"   // [IpAddress3] If not using DHCP set Network mask
#define WIFI_DNS               "192.168.51.1"    // [IpAddress4] If not using DHCP set DNS IP address (might be equal to WIFI_GATEWAY)

#define STA_SSID1              "pi005"         // [Ssid1] Wifi SSID
...
#else
  #define MQTT_HOST            "192.168.49.83"          // [MqttHost] owl2
...
#define MQTT_FULLTOPIC         "tydwr/greenhouse/%topic%/%prefix%/" // [FullTopic] Subscribe and Publish full topic name - Legacy topic
...
#define MQTT_GRPTOPIC          "sonoff"         // [GroupTopic] MQTT Group topic
...
#define TIME_DST               North, Last, Sun, Mar, 2, +60  // Northern Hemisphere, Last sunday in march at 02:00 +120 minutes

// -- Time - Start Standard Time and timezone offset from UTC in minutes
#define TIME_STD               North, Last, Sun, Oct, 3, +00   // Northern Hemisphere, Last sunday in october 02:00 +60 minutes
