...
#define CFG_HOLDER             0x19021101      // [Reset 1] Change this value to load following default configuration parameters
#define SAVE_DATA              1                 // [SaveData] Save changed parameters to Flash (0 = disable, 1 - 3600 seconds)
#define SAVE_STATE             1                 // [SetOption0] Save changed power state to Flash (0 = disable, 1 = enable)

// -- Wifi ----------------------------------------
#define WIFI_IP_ADDRESS        "192.168.50.77"         // [IpAddress1] Set to 0.0.0.0 for using DHCP or IP address
#define WIFI_GATEWAY           "192.168.50.1"   // {IpAddress2] If not using DHCP set Gateway IP address
...
#define STA_SSID1              "pi02"      // [Ssid1] Wifi SSID
...
// -- Ota -----------------------------------------
#define OTA_URL                "http://192.168.49.92:1880/.pioenvs/s001/firmware.bin"
...
#define KEY_HOLD_TIME          15                // [SetOption32] Number of 0.1 seconds to hold Button or external Pushbutton before sending HOLD message
